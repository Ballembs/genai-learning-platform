...
import { Mail, Lock, Github, AlertCircle, Loader2, ArrowLeft, CheckCircle } from 'lucide-react';
      ...
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-slate-900 rounded-2xl p-8 text-center">
          ...
          <p className="text-slate-400 mb-6">
            Supabase authentication is not set up. Your progress is saved locally.
          </p>
          <Link
            href="/course"
    ...
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
        <motion.div
          ...
          className="max-w-md w-full bg-slate-900 rounded-2xl p-8 text-center"
        >
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-slate-900 rounded-2xl p-8 border border-slate-800">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-3 bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-gradient-to-r from-cyan-500 to-purple-500 text-white rounded-lg font-medium hover:from-cyan-600 hover:to-purple-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
        ...
        <p className="mt-6 text-center text-slate-500 text-sm">
          <Link href="/course" className="hover:text-slate-400">
